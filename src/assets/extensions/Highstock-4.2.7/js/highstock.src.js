...
// encapsulated variables
    ...
    SVGRenderer.prototype = {
        ...
        */
         ...
         * @param {Number} innerR Inner radius like used in donut datavisualisation
    ...
    if (useCanVG) {
        ...
        CanVGController = (function () {
            ...
            /**
             * When downloaded, we are ready to draw deferred datavisualisation.
             */
    ...
    Axis.prototype = {
        ...
        init: function (chart, userOptions) {
            ...
            // inverted datavisualisation have reversed xAxes as default
        ...
        setTickInterval: function (secondPass) {
            ...
            // In column-like datavisualisation, don't cramp in more ticks than there are points (#1943, #4184)
     ...
     * of segments in stock datavisualisation, the normalizing logic was extracted in order to
    ...
    Tooltip.prototype = {
        ...
        refresh: function (point, mouseEvent) {
            ...
            // get the reference point coordinates (pie datavisualisation use tooltipPos)
    ...
    Pointer.prototype = {
        ...
        /**
         * With line type datavisualisation with a single tracker, get the point closest to the mouse.
    ...
    Chart.prototype = {
        ...
        getContainer: function () {
            ...
            // datavisualisation[oldChartIndex] will point to the wrong chart if any (#2609).
            ...
            // Add a reference to the datavisualisation index
        ...
        destroy: function () {
            ...
            // Delete the chart from datavisualisation lookup array
    ...
    Series.prototype = {
        ...
        processData: function (force) {
            ...
            while (--i) {
                ...
                // navigation in Stock datavisualisation (#725) and width calculation of columns (#1900)
    ...
    Series.prototype.setStackedPoints = function () {
        ...
        for (i = 0; i < yDataLength; i++) {
            ...
            if (y !== null) {
                ...
                // In area datavisualisation, if there are multiple points on the same X value, let the
    ...
    */
    ...
    var TrackerMixin = Highcharts.TrackerMixin = {
         ...
         * track mouse events on the graph or points. For the line type datavisualisation
    ...
    var DATA_GROUPING = 'dataGrouping',
        ...
        commonOptions = {
            ...
            //enabled: null, // (true for stock datavisualisation, false for basic),
            //forced: undefined,
            groupPixelWidth: 2,
    ...
    */
    ...
    Navigator.prototype = {
        ...
        init: function () {
            ...
            /**
             * For stock datavisualisation, extend the Chart.getMargins method so that we can set the final top position
    ...
    /**
     * For Stock datavisualisation, override selection zooming with some special features because
    ...
    // Initialize scroller for stock datavisualisation
    ...
    // Override getPlotLinePath to allow for multipane datavisualisation
    ...
    // Override getPlotBandPath to allow for multipane datavisualisation
    ...
    wrap(Series.prototype, 'render', function (proceed) {
        // Only do this on stock datavisualisation (#2939), and only if the series type handles clipping

...
var arrayMin = Highcharts.arrayMin,
    ...
    extend(Pane.prototype, {
        ...
        init: function (options, chart, firstAxis) {
            ...
            // Set options. Angular datavisualisation have a default background (#3318)
    ...
    wrap(axisProto, 'init', function (proceed, chart, userOptions) {
        ...
        if (!isHidden && (angular || polar)) {
            ...
            this.angleRad = (options.angle || 0) * Math.PI / 180; // Y axis in polar datavisualisation
        ...
        getGraphPath: function (points) {
            ...
            while (i--) {
                ...
                pointShim = {
                    ...
                    plotX: pick(point.plotHighX, point.plotX), // plotHighX is for polar datavisualisation
    ...
    (function () {
        ...
        /**
         * Extensions for polar datavisualisation. Additionally, much of the geometry required for polar datavisualisation is
        ...
        /**
         * Search a k-d tree by the point angle, used for shared tooltips in polar datavisualisation
         */
        ...
        wrap(seriesProto, 'getGraphPath', function (proceed, points) {
            ...
            if (this.chart.polar) {
                ...
                // For area datavisualisation, pseudo points are added to the graph, now we need to translate these
                each(points, function (point) {
        ...
        function polarAnimate(proceed, init) {
            ...
            // Specific animation for polar datavisualisation
            if (chart.polar) {

                // Enable animation on polar datavisualisation only in SVG. In VML, the scaling is different, plus animation
            ...
            // For non-polar datavisualisation, revert to the basic animation
            } else {
